...
def connectToUDP(arrayOfParams):
    ...
    message = "algo jajajaja"
    mi_socket.sendto(message.encode(), server_address)
    print("connection to UDP server was done succesfully!")
...
connectToUDP(["udpServer","localhost","5002","-l", "fileName"])